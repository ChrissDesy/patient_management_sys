...
public class preCheck extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PATIENT PRECHECK");
        ...
        temp.setBackground(new java.awt.Color(204, 255, 255));
        temp.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        blood.setBackground(new java.awt.Color(204, 255, 255));
        blood.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("Blood Pressure");

        weight.setBackground(new java.awt.Color(204, 255, 255));
        ...
        notes.setBackground(new java.awt.Color(204, 255, 255));
        notes.setColumns(20);
        notes.setRows(5);
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(blood, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(temp, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel4Layout.createSequentialGroup()
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(resp){
//            JOptionPane.showMessageDialog(null, "Precheck Added Successfully.", "CONFIRMATION", JOptionPane.INFORMATION_MESSAGE);
                              
            try {
                    con = DBConnect.getConnection();
                    pst = con.prepareStatement("UPDATE visits SET stage='precheck' WHERE id='"+vnum.getText()+"'");
                    pst.executeUpdate();
...
//                    JOptionPane.showMessageDialog(null,"USER DELETED..!!!","Confirmation",JOptionPane.INFORMATION_MESSAGE);
            ...
            JOptionPane.showMessageDialog(null, "FAILED TO ADD PRECHECK..!!!\n try again", "ERROR",0);
        }
