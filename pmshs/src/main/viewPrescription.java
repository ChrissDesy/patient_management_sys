...
public class viewPrescription extends javax.swing.JFrame {
    ...
    public viewPrescription() {
        ...
        prescId = controller.getPrescId();
        
        try{
            Connection con = DBConnect.getConnection();
            Statement st = con.createStatement();
            String query = "select p.patid, fname, lname, email, phone, gender, natid, r.visitid, r.id as ref, r.date, r.description, r.done_by " +
                            "from patients as p, prescription as r " +
                            "where r.patid = p.patid and r.status = 'active' " +
                            "and r.id = " + prescId;
            ...
            if(rs.next()){
                ...
                vnum1.setText(rs.getString("date"));
                vnum2.setText(rs.getString("done_by"));
                vnum3.setText(rs.getString("ref"));
    ...
    private void initComponents() {
        ...
        vnum1 = new javax.swing.JLabel();
        vnum2 = new javax.swing.JLabel();
        vnum3 = new javax.swing.JLabel();
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(vnum, javax.swing.GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
                        .addGap(21, 21, 21))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(vnum3, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(39, 39, 39)
                                .addComponent(jLabel7, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(vnum1, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jLabel9, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(vnum2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                .addContainerGap())
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        boolean resp = controller.approvePrescription("denied", Integer.toString(prescId));
        
        if(resp){
            JOptionPane.showMessageDialog(null, "Prescription Denied Successfully.", "CONFIRMATION", JOptionPane.INFORMATION_MESSAGE);
            dispose();
        }
        else{
            JOptionPane.showMessageDialog(null, "FAILED TO DENY..!!!\n try again", "ERROR",0);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        boolean resp = controller.approvePrescription("approve", Integer.toString(prescId));
        
        if(resp){
            JOptionPane.showMessageDialog(null, "Approved for Dispatch Successfully.", "CONFIRMATION", JOptionPane.INFORMATION_MESSAGE);
            dispose();
        }
        else{
            JOptionPane.showMessageDialog(null, "FAILED TO ADD APPROVE..!!!\n try again", "ERROR",0);
        }
    ...
    private javax.swing.JLabel vnum1;
    private javax.swing.JLabel vnum2;
    private javax.swing.JLabel vnum3;
