...
public class report5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PHARMACY HISTORY REPORT");
        ...
        jButton2.setText("View Pharmacy Notes");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String pid = model.getValueAt(row, 7).toString();
        
        controller.prescId = Integer.parseInt(pid);

        new prescription().show(true);
    ...
    public void jtPopulate(){
        ...
        Object[] colum = {"Visit ID","Patient ID","Fullname","Date","Done By","Status","Approved By", "Ref"};
        ...
        try{
           ...
           String query = "select p.id, p.date, done_by, approved_by, p.status, p.patid, p.visitid, s.fname, lname " +
                            "from prescription as p, patients as s " +
                            "where p.patid = s.patid";
           ResultSet rst=st.executeQuery(query);
           while(rst.next()){               
               
               row[0] = rst.getString("visitid");               
               row[2] = rst.getString("fname") + " " + rst.getString("lname");
               row[3] = rst.getString("date");
               row[4] = rst.getString("done_by");
               row[5] = rst.getString("status");
               row[1] = rst.getString("patid");
               row[6] = rst.getString("approved_by");
               row[7] = rst.getString("id");
